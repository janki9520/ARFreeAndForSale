...
//  ARFreeAndForSale
//
//  Created by Janki Patel on 10.20.18.
...
class commentVC: UIViewController, UITextViewDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        //placeholder for comment UITextView
        commentTxt.text = "Write a comment with @username and first hashtag mentioned on user post"
